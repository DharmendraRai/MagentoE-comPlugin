...
try {
  ini_set('SMTP', 'smtp.yourisp.net'); // must be set to your own local ISP
    ...
    ini_set('sendmail_from', 'raijiballia@gmail.com'); // can be any e-mail address, but must be set

    $to = 'raijiballia@gmail.com'; // the address that will receive the e-mail
    ...
    $headers .= 'From: developer.dharam@gmail.com'; // This instruction overrides sendmail_from above. IMPORTANT: do not include PHP_EOL here
